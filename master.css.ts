    ...
    variables: {
        color: {
            ...
            imemo: {
                ...
                // 新しいベージュ/ブラウン系カラー
                beige: {
                    50: "rgba(250, 248, 245, 1)",
                    100: "rgba(245, 240, 233, 1)",
                    200: "rgba(237, 228, 215, 1)",
                    300: "rgba(228, 215, 197, 1)",
                    400: "rgba(214, 198, 171, 1)",
                    500: "rgba(198, 180, 153, 1)",
                },
                brown: {
                    100: "rgba(215, 204, 189, 1)",
                    200: "rgba(189, 171, 148, 1)",
                    300: "rgba(163, 145, 122, 1)",
                    400: "rgba(134, 106, 80, 1)",
                    500: "rgba(115, 89, 66, 1)",
                    600: "rgba(96, 74, 54, 1)",
                    700: "rgba(81, 62, 62, 1)",
                },
                pink: "rgba(254, 186, 170, 1)",
